...
def main():
    ...
    # Model
    model = NAFNet(img_channel=3, width=cfg.width).to(device)
    ...
    for epoch in range(start_epoch, cfg.epochs + 1):
        ...
        if (epoch % cfg.val_every) == 0:
            ...
            # swap EMA weights into the SAME model (no extra GPU model)
